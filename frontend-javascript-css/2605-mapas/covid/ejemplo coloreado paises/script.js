...
var casos = [
  ...
  {
    "": 33,
    "city.cityName": "外地来京人员",
    "city.confirmedCount": 9,
    "city.suspectedCount": 0,
    "city.curedCount": 0,
    "city.deadCount": 0,
    "provinceName": "北京市",
  ...
  },
  {
    ...
    "curedCount": 0,
    "deadCount": 0,
    "comment": "福建地区新增疑似 2 例（漳州 1 例；三明 1 例）"
  },
  {
    "": 92,
    "city.cityName": "厦门",
...
/*
objeto con los datos JSON de los poligonos definiendo paises del mundo
*/
...
ejemplo de :
-geoJSON de paises
-personalizar poligonos de geoJSON colorear
-marcadores en la capa overlay
-popup marcador
-popup poligono cin el id del pais
-baselayers de los tilelayers
-overlays
...
L.marker([40.4, -3.7]).bindPopup('Madrid').addTo(cities),
	L.marker([35.7, 139.6]).bindPopup('Tokio').addTo(cities),
	L.marker([37.8, -119.5]).bindPopup('Yosemite NP').addTo(cities),
	L.marker([-27.4, 153.3]).bindPopup('Brisbane').addTo(cities);
...
// crear el mapa
var map = L.map('mapid', {
	center: [35.86, 104.19], // punto central del mapa
...
casos.forEach(element => {
	var ciudad = element["city.cityName"];
	var confirmados = element["city.confirmedCount"];
	var radius = Math.log(confirmados + 1) * 100000 + 15000;

	var circle = L.circle([contagios[ciudad][1], contagios[ciudad][0]], {
		color: 'red',
		fillColor: 'red',
		fillOpacity: 0.5,
		radius: radius
...
/*
for (const item in contagios) {
	
	var circle = L.circle([contagios[item][1], contagios[item][0]], {
		color: 'red',
		fillColor: 'red',
		fillOpacity: 0.5,
		radius: 50000
...
*/
L.marker([30.595, 114.2975], {
  icon: L.divIcon({
    html: '<h1>Wuhan</h1>',
    className: 'label-texto'
  })
}).addTo(map);

var rect = L.polygon([
  [35, 90],  // noroeste
  [35, 93],  // noreste  (misma lat)
  [30, 93],  // sureste  (misma lng)
  [30, 90]   // suroeste  (misma lat)
]).addTo(map);
