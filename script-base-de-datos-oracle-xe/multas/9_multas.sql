...
CREATE  TABLE  MATRICULAS(
  MATRICULA	  VARCHAR2(10)	CONSTRAINT PKMATRICULAS PRIMARY KEY,
  DNI		  VARCHAR2(30)	NOT NULL CONSTRAINT FKMATRICULAS REFERENCES PERSONAS
);

CREATE  TABLE  MULTAS(
  REF		  VARCHAR2(20)	CONSTRAINT PKMULTAS PRIMARY KEY,
  MATRICULA	  VARCHAR2(10) 	NOT NULL CONSTRAINT FKMULTAS REFERENCES MATRICULAS,
...
REM*******************************************************************
REM*****************  INSERCION DE VALORES EN TABLAS  ****************
REM*******************************************************************
...
INSERT INTO MULTAS VALUES('0012365478','3368-CCC',1500,'CONDE DE PEÑALVER 48');
...
INSERT INTO MULTAS VALUES('3719845962','4587-DVQ',468,'GREGORIO MARAÑON 27');
