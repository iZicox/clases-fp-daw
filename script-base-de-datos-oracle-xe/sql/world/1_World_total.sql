-- Comentar los DROP TABLE en la primera ejecución del script
...
INSERT INTO country VALUES ('DZA','Algeria','Africa','Northern Africa',2381741.00,1962,31471000,69.7,49982.00,46966.00,'Al-Jazair/Algérie','Republic','Abdelaziz Bouteflika',35,'DZ');
...
INSERT INTO country VALUES ('SAU','Saudi Arabia','Asia','Middle East',2149690.00,1932,21607000,67.8,137635.00,146171.00,'Al-´Arabiya as-Saudiya','Monarchy','Fahd ibn Abdul-Aziz al-Sa´ud',3173,'SA');
...
INSERT INTO city VALUES (417,'I tuba','BRA','Pará',101320);
