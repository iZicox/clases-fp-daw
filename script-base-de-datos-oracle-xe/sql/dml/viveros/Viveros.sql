...
DROP TABLE EMPLEADO;
DROP TABLE TIENDA;
DROP TABLE TOTAL_TIPOS_PRODUCTOS_PAIS;

alter session set nls_date_format = 'YYYY-MM-DD';

CREATE TABLE tienda (
  codTienda VARCHAR2(10) NOT NULL,
...
CREATE TABLE cliente (
  ...
  apellidoContacto VARCHAR2(30),
  telefono VARCHAR2(15) NOT NULL,
  telefono2 VARCHAR2(15) NOT NULL,
  lineaDireccion1 VARCHAR2(50) NOT NULL,
  lineaDireccion2 VARCHAR2(50) ,
  ...
  codEmpleadoVentas Number,
  limiteCredito Number(15,2) ,
  PRIMARY KEY (codCliente),
  constraint fk_empledo_cliente
  FOREIGN KEY (codEmpleadoVentas) REFERENCES empleado (codEmpleado)
);

CREATE TABLE pedido (
  codPedido Number NOT NULL,
...
CREATE TABLE producto (
  codProducto VARCHAR2(15) NOT NULL,
  ...
  FOREIGN KEY (TipoProducto) REFERENCES TipoProducto (tipo)
);
...
CREATE TABLE pago (
  ...
  idTransaccion VARCHAR2(50) NOT NULL,
  fechaPago date NOT NULL,
  ImporteTotal number(15,2) NOT NULL,
  PRIMARY KEY (codCliente, idTransaccion),
  constraint fk_cliente_pago
  FOREIGN KEY (codCliente) REFERENCES cliente (codCliente)
);

/*Datos-------------------------------------------*/
INSERT INTO tienda VALUES ('BCN-ES','Barcelona','España','Barcelona','08019','+34 93 3561182','Avenida Diagonal, 38','3A escalera Derecha');
INSERT INTO tienda VALUES ('BOS-USA','Boston','EEUU','MA','02108','+1 215 837 0825','1550 Court Place','Suite 102');
INSERT INTO tienda VALUES ('LON-UK','Londres','Inglaterra','EMEA','EC2N 1HN','+44 20 78772041','52 Old Broad Street','Ground Floor');
INSERT INTO tienda VALUES ('MAD-ES','Madrid','España','Madrid','28028','+34 91 7514487','Paseo de la Castellana, 32','');
INSERT INTO tienda VALUES ('PAR-FR','Paris','Francia','EMEA','75017','+33 14 723 4404','17 rue Lucien Sampaix','');
INSERT INTO tienda VALUES ('SFC-USA','San Francisco','EEUU','CA','94080','+1 650 219 4782','100 Market Street','Suite 300');
INSERT INTO tienda VALUES ('SYD-AU','Sydney','Australia','APAC','NSW 2010','+61 2 9264 2451','5-11 Wentworth Avenue','Floor #2');
INSERT INTO tienda VALUES ('VAL-ES','Valencia','España','Valencia','46007','+34 965 867231','Gran Vía, 32','5º piso (exterior)');
INSERT INTO tienda VALUES ('TOK-JP','Tokyo','Japón','Chiyoda-Ku','102-8578','+81 33 224 5000','4-1 Kioicho','');

INSERT INTO empleado VALUES (1,'Marta','Martín','Perez','3897','marta@vivero.es','VAL-ES',NULL,'Directora General');
INSERT INTO empleado VALUES (2,'Rubén','López','Martinez','2899','rlopez@vivero.es','VAL-ES',1,'Subdirector Marketing');
INSERT INTO empleado VALUES (3,'Álvaro','Ríos','Carrasco','2837','arios@vivero.es','VAL-ES',2,'Subdirector Ventas');
INSERT INTO empleado VALUES (4,'María','Tola','Jerez','2847','mtola@vivero.es','VAL-ES',2,'Secretaria');
INSERT INTO empleado VALUES (5,'Fernando','Rota','Mano','2844','frota@vivero.es','VAL-ES',3,'Representante Ventas');
INSERT INTO empleado VALUES (6,'Juan Carlos','Navarro','Serrano','2845','jcnavarro@vivero.es','VAL-ES',3,'Representante Ventas');
INSERT INTO empleado VALUES (7,'Carlota','Tola','Jimenez','2444','ctola@vivero.es','MAD-ES',3,'Directora tienda');
INSERT INTO empleado VALUES (8,'Mariano','García','Escorial','2442','mgarcia@vivero.es','MAD-ES',7,'Representante Ventas');
INSERT INTO empleado VALUES (9,'Lucía','Bueno','Mañas','2442','lbueno@vivero.es','MAD-ES',7,'Representante Ventas');
INSERT INTO empleado VALUES (10,'Hilario','Abeto','Huertas','2444','habeto@vivero.es','MAD-ES',7,'Representante Ventas');
INSERT INTO empleado VALUES (11,'Pol','Perez','Perez','2518','polp@vivero.es','BCN-ES',3,'Director tienda');
INSERT INTO empleado VALUES (12,'Sandra','Martinez','De la Osa','2519','smart@hotmail.es','BCN-ES',11,'Representante Ventas');
INSERT INTO empleado VALUES (13,'Marina','Palma','Olivo','2519','mpalma@vivero.es','BCN-ES',11,'Representante Ventas');
INSERT INTO empleado VALUES (14,'Mateo','Palma','Olivo','2519','mtpalma@vivero.es','BCN-ES',11,'Representante Ventas');
INSERT INTO empleado VALUES (15,'Cedric','Fignau','','9981','cfignau@gardening.com','PAR-FR',3,'Director tienda');
INSERT INTO empleado VALUES (16,'Eric','Dubois','','9982','edubois@gardening.com','PAR-FR',15,'Representante Ventas');
INSERT INTO empleado VALUES (17,'Laurent','Marinne','','9982','lmarinne@gardening.com','PAR-FR',15,'Representante Ventas');
INSERT INTO empleado VALUES (18,'Jax','Teller','','7454','jteller@gardening.com','SFC-USA',3,'Director tienda');
INSERT INTO empleado VALUES (19,'Walter','Bross','Lopez','7454','wbross@gardening.com','SFC-USA',18,'Representante Ventas');
INSERT INTO empleado VALUES (20,'John','Walker','','7565','jwalker@gardening.com','BOS-USA',3,'Director tienda');
INSERT INTO empleado VALUES (21,'Marcus','Smart','','7565','msmart@gardening.com','BOS-USA',20,'Representante Ventas');
INSERT INTO empleado VALUES (22,'Lorena','Bobbit','','7665','lbobbit@gardening.com','BOS-USA',20,'Representante Ventas');
INSERT INTO empleado VALUES (23,'Naruto','Uzumaki','','8734','nuzumaki@gardening.com','TOK-JP',3,'Director tienda');
INSERT INTO empleado VALUES (24,'Sakura','Haruno','','8734','sharuno@gardening.com','TOK-JP',23,'Representante Ventas');
INSERT INTO empleado VALUES (25,'Himura','Kenshin','','8735','hkenshin@gardening.com','TOK-JP',23,'Representante Ventas');
INSERT INTO empleado VALUES (26,'Boris','Johnson','','3321','bjohnson@gardening.com','LON-UK',3,'Director tienda');
INSERT INTO empleado VALUES (27,'Michael','Rivers','','3322','mrivers@gardening.com','LON-UK',26,'Representante Ventas');
INSERT INTO empleado VALUES (28,'Donald','Douglas','','3322','ddouglas@gardening.com','LON-UK',26,'Representante Ventas');
INSERT INTO empleado VALUES (29,'Chris','Weiss','','3210','cweiss@gardening.com','SYD-AU',3,'Director tienda');
INSERT INTO empleado VALUES (30,'Julian','Forks','','3211','jforks@gardening.com','SYD-AU',29,'Representante Ventas');
INSERT INTO empleado VALUES (31,'Rintarou','Okabe','','3211','rokabe@gardening.com','SYD-AU',29,'Representante Ventas');

INSERT INTO TipoProducto VALUES ('Hierbas','Plantas para jardin decorativas',NULL,NULL);
INSERT INTO TipoProducto VALUES ('Utensilios','Utensilios y macetas para todo',NULL,NULL);
INSERT INTO TipoProducto VALUES ('Aromáticas','Plantas aromáticas',NULL,NULL);
INSERT INTO TipoProducto VALUES ('Frutales','Árboles pequeños de frutas',NULL,NULL);
INSERT INTO TipoProducto VALUES ('Ornamentales','Plantas para la decoración del jardín',NULL,NULL);

INSERT INTO cliente VALUES (1,'GoldWarrior Garden','Daniel G','GoldFish','5556901745','5556901746','False Street 52 2 A',NULL,'San Francisco',NULL,'USA','24006',19,3000);
...
INSERT INTO cliente VALUES (6,'Lasas S.A.','Antonio','Lasas','34916540145','34914851312','C/Leganes 15',NULL,'Getafe','Madrid','Spain','28945',8,154310);
...
INSERT INTO cliente VALUES (8,'Club Golf El Canal','Paco','Lopez','62456810','919535678','C/sinesio delgado','Madrid','Madrid','Madrid','Spain','28930',11,40000);
...
INSERT INTO cliente VALUES (10,'DaraDistribuciones','David','Serrano','675598001','916421756','C/azores','Getafe','Madrid','Madrid','Spain','28946',11,50000);
INSERT INTO cliente VALUES (11,'Madrileña de aguas','Jose','Tacaño','655983045','916689215','C/Lagañas','Getafe','Madrid','Madrid','Spain','28943',11,20000);
INSERT INTO cliente VALUES (12,'Sans S.A.','Antonio','Lasas','34916540145','34914851312','C/Leganes 15',NULL,'Getafe','Madrid','Spain','28945',8,154310);
INSERT INTO cliente VALUES (13,'Chingona Jardines S.L.','Pedro','Camunas','34914873241','34914871541','C/Virgenes 45','C/Princesas 2 1ºB','San Lorenzo del Escorial','Madrid','Spain','28145',8,16481);
...
INSERT INTO cliente VALUES (15,'Jardin de Florecillas','Javier','Villar','654865643','914538776','C/ Oña 34',NULL,'Madrid','Madrid','Spain','28950',30,40000);
INSERT INTO cliente VALUES (16,'Flores Victoria','Maria','Rodriguez','666555444','912458657','C/Leganes 24',NULL,'Getafe','Madrid','Spain','28945',5,1500);
INSERT INTO cliente VALUES (17,'Flowers, S.A','Beatriz','Fernandez','698754159','978453216','C/Luis Salquillo  ',NULL,'Montornes del valles','Barcelona','Spain','24586',5,3500);
INSERT INTO cliente VALUES (18,'Natura bubbles','Victoria','Cruz','612343529','916548735','Plaza Magallón 15',NULL,'Madrid','Madrid','Spain','28011',30,5050);
INSERT INTO cliente VALUES (19,'Golfos S.A.','David','Martinez','916458762','912354475','C/Estancado',NULL,'Santa cruz de Tenerife','Islas Canarias','Spain','38297',12,30000);
INSERT INTO cliente VALUES (20,'Cabuts Golf Management SL','Mario','Suarez','964493072','964493063','C/Letardo',NULL,'Barcelona','Cataluña','Spain','12320',12,20000);
...
INSERT INTO cliente VALUES (22,'El besó','Francisco','Camacho','916882323','916493211','Avenida Tibidabo',NULL,'Barcelona','Cataluña','Spain','12320',12,30000);
...
INSERT INTO cliente VALUES (24,'Vivero Alcalá de Henares','Federico','Gomez','654987690','916040875','C/Miguel Echegaray 54',NULL,'Alcalá de Henares','Madrid','Spain','28970',30,7430);
INSERT INTO cliente VALUES (25,'Fuenla City','Tony','Muñoz Mena','675842139','915483754','C/Callo 52',NULL,'Getafe','Madrid','Spain','28574',5,4500);
...
INSERT INTO cliente VALUES (27,'Jardinerías Matías SL','Matías','San Martín','916544147','917897474','C/Francisco Arce, Nº44','Manzanares','Madrid','Madrid','Spain','37845',9,100500);
...
INSERT INTO cliente VALUES (29,'Top Campo','Joseluis','Sanchez','685746512','974315924','C/Ibiza 32',NULL,'Alcalá de Henares','Madrid','Spain','28574',5,5500);
INSERT INTO cliente VALUES (30,'vivero Tara','Tara','Marquez','675124537','912475843','C/Lima 1',NULL,'Getafe','Madrid','Spain','27584',5,7500);
INSERT INTO cliente VALUES (31,'Campofeliz','Luis','Feliz','645925376','916159116','C/Peru 78',NULL,'Getafe','Madrid','Spain','28945',30,3250);
INSERT INTO cliente VALUES (32,'Orange','François','Toulou','(33)5120578961','(33)5120578961','6 place d Alleray ',NULL,'Paris',NULL,'France','75010',16,10000);
INSERT INTO cliente VALUES (33,'Musée du Louvre','Pierre','Delacroix','(33)0140205050','(33)0140205442','Quai du Louvre',NULL,'Paris',NULL,'France','75058',16,30000);
...
INSERT INTO cliente VALUES (36,'Flores S.L.','Antonio','Romero','654352981','685249700','Avenida España',NULL,'Madrid','Getafe','Spain','29643',18,6000);
...
INSERT INTO cliente VALUES (38,'Hambletton Garden S.L','Justin','Smith','2 8005-7161','2 8005-7162','176 Cumberland Street The rocks',NULL,'Sydney','Nueva Gales del Sur','Australia','2003',31,8000);

alter session set NLS_DATE_FORMAT='yyyy-MM-dd';

INSERT INTO pedido VALUES (1,'2018-01-17','2018-01-19','2018-01-19','Entregado','Pagado a plazos',5);
INSERT INTO pedido VALUES (2,'2019-10-23','2019-10-28','2019-10-26','Entregado','La entrega llego antes de lo esperado',5);
INSERT INTO pedido VALUES (3,'2020-06-20','2020-06-25',NULL,'Rechazado','Limite de credito superado',5);
INSERT INTO pedido VALUES (4,'2021-01-20','2021-01-26',NULL,'Pendiente',NULL,5);
INSERT INTO pedido VALUES (8,'2020-11-09','2020-11-14','2020-11-14','Entregado','El cliente paga la mitad con tarjeta y la otra mitad con efectivo, se le realizan dos facturas',1);
INSERT INTO pedido VALUES (9,'2020-12-22','2020-12-27','2020-12-28','Entregado','El cliente comprueba la integridad del paquete, todo correcto',1);
INSERT INTO pedido VALUES (10,'2021-01-15','2021-01-20',NULL,'Pendiente','El cliente llama para confirmar la fecha - Esperando al proveedor',3);
INSERT INTO pedido VALUES (11,'2021-01-20','2021-01-27',NULL,'Pendiente','El cliente requiere que el pedido se le entregue de 16:00h a 22:00h',1);
INSERT INTO pedido VALUES (12,'2021-01-22','2021-01-27',NULL,'Pendiente','El cliente requiere que el pedido se le entregue de 9:00h a 13:00h',1);
INSERT INTO pedido VALUES (13,'2021-01-12','2021-01-14','2021-01-15','Entregado',NULL,7);
INSERT INTO pedido VALUES (14,'2021-01-02','2021-01-02',null,'Rechazado','mal pago',7);
INSERT INTO pedido VALUES (15,'2021-01-09','2021-01-12','2021-01-11','Entregado',NULL,7);
INSERT INTO pedido VALUES (16,'2021-01-06','2021-01-07','2021-01-15','Entregado',NULL,7);
INSERT INTO pedido VALUES (17,'2021-01-08','2021-01-09','2021-01-11','Entregado','mal estado',7);
INSERT INTO pedido VALUES (18,'2021-01-05','2021-01-06','2021-01-07','Entregado',NULL,9);
INSERT INTO pedido VALUES (19,'2021-01-18','2021-02-12',NULL,'Pendiente','entregar en murcia',9);
INSERT INTO pedido VALUES (20,'2021-01-20','2021-02-15',NULL,'Pendiente',NULL,9);
INSERT INTO pedido VALUES (21,'2021-01-09','2021-01-09','2021-01-09','Rechazado','mal pago',9);
INSERT INTO pedido VALUES (22,'2021-01-11','2021-01-11','2021-01-13','Entregado',NULL,9);
INSERT INTO pedido VALUES (23,'2020-12-30','2021-01-10',NULL,'Rechazado','El pedido fue anulado por el cliente',5);
INSERT INTO pedido VALUES (24,'2020-07-14','2020-07-31','2020-07-25','Entregado',NULL,14);
INSERT INTO pedido VALUES (25,'2021-02-02','2021-02-08',NULL,'Rechazado','El cliente carece de saldo en la cuenta asociada',1);
INSERT INTO pedido VALUES (26,'2021-02-06','2021-02-12',NULL,'Rechazado','El cliente anula la operacion para adquirir mas producto',3);
INSERT INTO pedido VALUES (27,'2021-02-07','2021-02-13',NULL,'Entregado','El pedido aparece como entregado pero no sabemos en que fecha',3);
INSERT INTO pedido VALUES (28,'2021-02-10','2021-02-17','2021-02-20','Entregado','El cliente se queja bastante de la espera asociada al producto',3);
INSERT INTO pedido VALUES (29,'2020-08-01','2020-09-01','2020-09-01','Rechazado','El cliente no está conforme con el pedido',14);
INSERT INTO pedido VALUES (30,'2020-08-03','2020-09-03','2020-08-31','Entregado',NULL,13);
INSERT INTO pedido VALUES (31,'2020-09-04','2020-09-30','2020-10-04','Rechazado','El cliente ha rechazado por llegar 5 dias tarde',13);
INSERT INTO pedido VALUES (32,'2019-01-07','2019-01-19','2019-01-27','Entregado','Entrega tardia, el cliente puso reclamacion',4);
INSERT INTO pedido VALUES (33,'2019-05-20','2019-05-28',NULL,'Rechazado','El pedido fue anulado por el cliente',4);
INSERT INTO pedido VALUES (34,'2019-06-20','2020-06-28','2020-06-28','Entregado','Pagado a plazos',4);
INSERT INTO pedido VALUES (35,'2020-03-10','2021-03-20',NULL,'Rechazado','Limite de credito superado',4);
INSERT INTO pedido VALUES (36,'2020-10-15','2020-12-15','2020-12-10','Entregado',NULL,14);
INSERT INTO pedido VALUES (37,'2020-11-03','2021-11-13',NULL,'Pendiente','El pedido nunca llego a su destino',4);
INSERT INTO pedido VALUES (38,'2021-03-05','2021-03-06','2021-03-07','Entregado',NULL,19);
INSERT INTO pedido VALUES (39,'2021-03-06','2021-03-07','2021-03-09','Pendiente',NULL,19);
INSERT INTO pedido VALUES (40,'2021-03-09','2021-03-10','2021-03-13','Rechazado',NULL,19);
INSERT INTO pedido VALUES (41,'2021-03-12','2021-03-13','2021-03-13','Entregado',NULL,19);
INSERT INTO pedido VALUES (42,'2021-03-22','2021-03-23','2021-03-27','Entregado',NULL,19);
INSERT INTO pedido VALUES (43,'2021-03-25','2021-03-26','2021-03-28','Pendiente',NULL,23);
INSERT INTO pedido VALUES (44,'2021-03-26','2021-03-27','2021-03-30','Pendiente',NULL,23);
INSERT INTO pedido VALUES (45,'2021-04-01','2021-03-04','2021-03-07','Entregado',NULL,23);
INSERT INTO pedido VALUES (46,'2021-04-03','2021-03-04','2021-03-05','Rechazado',NULL,23);
INSERT INTO pedido VALUES (47,'2021-04-15','2021-03-17','2021-03-17','Entregado',NULL,23);
INSERT INTO pedido VALUES (48,'2020-03-17','2020-03-30','2020-03-29','Entregado','Según el Cliente, el pedido llegó defectuoso',26);
INSERT INTO pedido VALUES (49,'2020-07-12','2020-07-22','2020-07-30','Entregado','El pedido llegó 1 día tarde, pero no hubo queja por parte de la empresa compradora',26);
INSERT INTO pedido VALUES (50,'2020-03-17','2020-08-09',NULL,'Pendiente','Al parecer, el pedido se ha extraviado a la altura de Sotalbo (Ávila)',26);
INSERT INTO pedido VALUES (51,'2020-10-01','2020-10-14','2020-10-14','Entregado','Todo se entregó a tiempo y en perfecto estado, a pesar del pésimo estado de las carreteras.',26);
INSERT INTO pedido VALUES (52,'2020-12-07','2020-12-21',NULL,'Pendiente','El transportista ha llamado a Eva María para indicarle que el pedido llegará más tarde de lo esperado.',26);
INSERT INTO pedido VALUES (53,'2020-10-15','2020-11-15','2020-11-09','Entregado','El pedido llega 6 dias antes',13);
INSERT INTO pedido VALUES (54,'2021-01-11','2021-02-11',NULL,'Pendiente',NULL,14);
INSERT INTO pedido VALUES (55,'2020-12-10','2021-01-10','2021-01-11','Entregado','Retrasado 1 dia por problemas de transporte',14);
INSERT INTO pedido VALUES (56,'2020-12-19','2021-01-20',NULL,'Rechazado','El cliente a anulado el pedido el dia 2021-01-10',13);
INSERT INTO pedido VALUES (57,'2021-01-05','2021-02-05',NULL,'Pendiente',NULL,13);
INSERT INTO pedido VALUES (58,'2021-01-24','2021-01-31','2021-01-30','Entregado','Todo correcto',3);
INSERT INTO pedido VALUES (59,'2020-11-09','2020-11-14','2020-11-14','Entregado','El cliente paga la mitad con tarjeta y la otra mitad con efectivo, se le realizan dos facturas',1);
INSERT INTO pedido VALUES (60,'2020-12-22','2020-12-27','2020-12-28','Entregado','El cliente comprueba la integridad del paquete, todo correcto',1);
INSERT INTO pedido VALUES (61,'2021-01-15','2021-01-20',NULL,'Pendiente','El cliente llama para confirmar la fecha - Esperando al proveedor',3);
INSERT INTO pedido VALUES (62,'2021-01-20','2021-01-27',NULL,'Pendiente','El cliente requiere que el pedido se le entregue de 16:00h a 22:00h',1);
INSERT INTO pedido VALUES (63,'2021-01-22','2021-01-27',NULL,'Pendiente','El cliente requiere que el pedido se le entregue de 9:00h a 13:00h',1);
INSERT INTO pedido VALUES (64,'2021-01-24','2021-01-31','2021-01-30','Entregado','Todo correcto',1);
INSERT INTO pedido VALUES (65,'2021-02-02','2021-02-08',NULL,'Rechazado','El cliente carece de saldo en la cuenta asociada',1);
INSERT INTO pedido VALUES (66,'2021-02-06','2021-02-12',NULL,'Rechazado','El cliente anula la operacion para adquirir mas producto',3);
INSERT INTO pedido VALUES (67,'2021-02-07','2021-02-13',NULL,'Entregado','El pedido aparece como entregado pero no sabemos en que fecha',3);
INSERT INTO pedido VALUES (68,'2021-02-10','2021-02-17','2021-02-20','Entregado','El cliente se queja bastante de la espera asociada al producto',3);
INSERT INTO pedido VALUES (74,'2021-01-14','2021-01-22',NULL,'Rechazado','El pedido no llego el dia que queria el cliente por fallo del transporte',15);
INSERT INTO pedido VALUES (75,'2021-01-11','2021-01-13','2021-01-13','Entregado','El pedido llego perfectamente',15);
INSERT INTO pedido VALUES (76,'2020-11-15','2020-11-23','2020-11-23','Entregado',NULL,15);
INSERT INTO pedido VALUES (77,'2021-01-03','2021-01-08',NULL,'Pendiente','El pedido no pudo ser entregado por problemas meteorologicos',15);
INSERT INTO pedido VALUES (78,'2020-12-15','2020-12-17','2020-12-17','Entregado','Fue entregado, pero faltaba mercancia que sera entregada otro dia',15);
INSERT INTO pedido VALUES (79,'2021-01-12','2021-01-13','2021-01-13','Entregado',NULL,28);
INSERT INTO pedido VALUES (80,'2021-01-25','2021-01-26',NULL,'Pendiente','No terminó el pago',28);
INSERT INTO pedido VALUES (81,'2021-01-18','2021-01-24',NULL,'Rechazado','Los producto estaban en mal estado',28);
INSERT INTO pedido VALUES (82,'2021-01-20','2021-01-29','2021-01-29','Entregado','El pedido llego un poco mas tarde de la hora fijada',28);
INSERT INTO pedido VALUES (83,'2021-01-24','2021-01-28',NULL,'Entregado',NULL,28);
INSERT INTO pedido VALUES (89,'2019-10-05','2019-12-13','2019-12-10','Entregado','La entrega se realizo dias antes de la fecha esperada por lo que el cliente quedo satisfecho',35);
INSERT INTO pedido VALUES (90,'2021-02-07','2020-02-17',NULL,'Pendiente','Debido a la nevada caída en la sierra, el pedido no podrá llegar hasta el día ',27);
INSERT INTO pedido VALUES (91,'2021-03-18','2021-03-29','2021-03-27','Entregado','Todo se entregó a su debido tiempo, incluso con un día de antelación',27);
INSERT INTO pedido VALUES (92,'2021-04-19','2021-04-30','2021-05-03','Entregado','El pedido se entregó tarde debido a la festividad celebrada en España durante esas fechas',27);
INSERT INTO pedido VALUES (93,'2021-05-03','2021-05-30','2021-05-17','Entregado','El pedido se entregó antes de lo esperado.',27);
INSERT INTO pedido VALUES (94,'2021-10-18','2021-11-01',NULL,'Pendiente','El pedido está en camino.',27);
INSERT INTO pedido VALUES (95,'2020-01-04','2020-01-19','2020-01-19','Entregado',NULL,35);
INSERT INTO pedido VALUES (96,'2020-03-20','2020-04-12','2020-04-13','Entregado','La entrega se retraso un dia',35);
INSERT INTO pedido VALUES (97,'2020-10-08','2020-11-25','2020-11-25','Entregado',NULL,35);
INSERT INTO pedido VALUES (98,'2021-01-08','2021-02-13',NULL,'Pendiente',NULL,35);
INSERT INTO pedido VALUES (99,'2021-02-15','2021-02-27',NULL,'Pendiente',NULL,16);
INSERT INTO pedido VALUES (100,'2021-01-10','2021-01-15','2021-01-15','Entregado','El pedido llego perfectamente',16);
INSERT INTO pedido VALUES (101,'2021-03-07','2021-03-27',NULL,'Rechazado','El pedido fue rechazado por el cliente',16);
INSERT INTO pedido VALUES (102,'2020-12-28','2021-01-08','2021-01-08','Entregado','Pago pendiente',16);
INSERT INTO pedido VALUES (103,'2021-01-15','2021-01-20','2021-01-24','Pendiente',NULL,30);
INSERT INTO pedido VALUES (104,'2021-03-02','2021-03-06','2021-03-06','Entregado',NULL,30);
INSERT INTO pedido VALUES (105,'2021-02-14','2021-02-20',NULL,'Rechazado','el producto ha sido rechazado por la pesima calidad',30);
INSERT INTO pedido VALUES (106,'2021-05-13','2021-05-15','2021-05-20','Pendiente',NULL,30);
INSERT INTO pedido VALUES (107,'2021-04-06','2021-04-10','2021-04-10','Entregado',NULL,30);
INSERT INTO pedido VALUES (108,'2021-04-09','2021-04-15','2021-04-15','Entregado',NULL,16);
INSERT INTO pedido VALUES (109,'2018-05-25','2018-07-28','2018-07-28','Entregado',NULL,38);
INSERT INTO pedido VALUES (110,'2019-03-19','2019-04-24','2019-04-24','Entregado',NULL,38);
INSERT INTO pedido VALUES (111,'2020-03-05','2020-03-30','2020-03-30','Entregado',NULL,36);
INSERT INTO pedido VALUES (112,'2021-03-05','2021-04-06','2021-05-07','Pendiente',NULL,36);
INSERT INTO pedido VALUES (113,'2020-10-28','2020-11-09','2021-01-09','Rechazado','El producto ha sido rechazado por la tardanza de el envio',36);
INSERT INTO pedido VALUES (114,'2021-01-15','2021-01-29','2021-01-31','Entregado','El envio llego dos dias más tarde debido al mal tiempo',36);
INSERT INTO pedido VALUES (115,'2020-11-29','2021-01-26','2021-02-27','Pendiente',NULL,36);
INSERT INTO pedido VALUES (116,'2020-06-28','2020-08-01','2020-08-01','Entregado',NULL,38);
INSERT INTO pedido VALUES (117,'2020-08-25','2020-10-01',NULL,'Rechazado','El pedido ha sido rechazado por la acumulacion de pago pendientes del cliente',38);
INSERT INTO pedido VALUES (118,'2021-02-15','2021-02-27',NULL,'Pendiente',NULL,16);
INSERT INTO pedido VALUES (119,'2021-01-10','2021-01-15','2021-01-15','Entregado','El pedido llego perfectamente',16);
INSERT INTO pedido VALUES (120,'2021-03-07','2021-03-27',NULL,'Rechazado','El pedido fue rechazado por el cliente',16);
INSERT INTO pedido VALUES (121,'2020-12-28','2021-01-08','2021-01-08','Entregado','Pago pendiente',16);
INSERT INTO pedido VALUES (122,'2021-04-09','2021-04-15','2021-04-15','Entregado',NULL,16);
INSERT INTO pedido VALUES (123,'2021-01-15','2021-01-20','2021-01-24','Pendiente',NULL,30);
INSERT INTO pedido VALUES (124,'2021-03-02','2021-03-06','2021-03-06','Entregado',NULL,30);
INSERT INTO pedido VALUES (125,'2021-02-14','2021-02-20',NULL,'Rechazado','el producto ha sido rechazado por la pesima calidad',30);
INSERT INTO pedido VALUES (126,'2021-05-13','2021-05-15','2021-05-20','Pendiente',NULL,30);
INSERT INTO pedido VALUES (127,'2021-04-06','2021-04-10','2021-04-10','Entregado',NULL,30);
INSERT INTO pedido VALUES (128,'2020-11-10','2020-12-10','2020-12-29','Rechazado','El pedido ha sido rechazado por el cliente por el retraso en la entrega',38);

INSERT INTO producto VALUES ('11679','Sierra de Poda 400MM','Utensilios','0,258','HiperGarden Tools','Gracias a la poda se consigue manipular un poco la naturaleza, dándole la forma que más nos guste. Este trabajo básico de jardinería también facilita que las plantas crezcan de un modo más equilibrado, y que las flores y los frutos vuelvan cada año con regularidad. Lo mejor es dar forma cuando los ejemplares son jóvenes, de modo que exijan pocos cuidados cuando sean adultos. Además de saber cuándo y cómo hay que podar, tener unas Utensilios adecuadas para esta labor es también de vital importancia.',15,14,11);
INSERT INTO producto VALUES ('21636','Pala','Utensilios','0,156','HiperGarden Tools','Palas de acero con cresta de corte en la punta para cortar bien el terreno. Buena penetración en tierras muy compactas.',15,14,13);
INSERT INTO producto VALUES ('22225','Rastrillo de Jardín','Utensilios','1,064','HiperGarden Tools','Fabuloso rastillo que le ayudará a eliminar piedras, hojas, ramas y otros elementos incómodos en su jardín.',15,12,11);
INSERT INTO producto VALUES ('30310','Azadón','Utensilios','0,168','HiperGarden Tools','Longitud:24cm. Herramienta fabricada en acero y pintura epoxi,alargando su durabilidad y preveniendo la corrosión.Diseño pensado para el ahorro de trabajo.',15,12,11);
...
INSERT INTO pago VALUES (1,'PayPal','ak-std-000001','2020-11-10',2000);
INSERT INTO pago VALUES (1,'PayPal','ak-std-000002','2020-12-10',2000);
...
INSERT INTO pago VALUES (4,'PayPal','ak-std-000006','2019-01-08',20000);
INSERT INTO pago VALUES (4,'PayPal','ak-std-000007','2019-01-08',20000);
INSERT INTO pago VALUES (4,'PayPal','ak-std-000008','2019-01-08',20000);
INSERT INTO pago VALUES (4,'PayPal','ak-std-000009','2019-01-08',20000);
INSERT INTO pago VALUES (4,'PayPal','ak-std-000010','2019-01-08',1849);
INSERT INTO pago VALUES (5,'Transferencia','ak-std-000011','2018-01-18',23794);
...
INSERT INTO pago VALUES (13,'PayPal','ak-std-000014','2020-08-04',2246);
INSERT INTO pago VALUES (14,'PayPal','ak-std-000015','2020-07-15',4160);
...
INSERT INTO pago VALUES (23,'PayPal','ak-std-000019','2021-03-26',272);
INSERT INTO pago VALUES (26,'PayPal','ak-std-000020','2020-03-18',18846);
INSERT INTO pago VALUES (27,'PayPal','ak-std-000021','2021-02-08',10972);
INSERT INTO pago VALUES (28,'PayPal','ak-std-000022','2021-01-13',8489);
INSERT INTO pago VALUES (30,'PayPal','ak-std-000024','2021-01-16',7863);
INSERT INTO pago VALUES (35,'PayPal','ak-std-000025','2019-10-06',3321);
INSERT INTO pago VALUES (38,'PayPal','ak-std-000026','2018-05-26',1171);
